...
> [jmcomic-ai](https://github.com/hect0x7/jmcomic-ai) 通过 **MCP (Model Context Protocol)** 和 Skills 将 `jmcomic` 的搜索、下载、排行榜等核心能力注入到你的 AI Agent（如 Cursor, Claude Desktop 等）中。现在你只需对 AI 说出“帮我找找主角是电锯人的漫画”或“下载搜索结果中浏览量前三的作品”，AI 就会自动为你执行复杂的爬虫任务。
